...
#pragma omp parallel for private(j,R222,R122,R212,R112,R221,R121,R211,R111,\
		...
		for (j = 0; j < model_num_; j++){
			if (fabs(forward_model_[j]) > ZERO){
				...
				w222=((x2-obs_p_[i].x)*(y2-obs_p_[i].y))/((pow(x2-obs_p_[i].x,2)+pow(z2-obs_p_[i].z,2))+R222*(z2-obs_p_[i].z));
				w122=((x1-obs_p_[i].x)*(y2-obs_p_[i].y))/((pow(x1-obs_p_[i].x,2)+pow(z2-obs_p_[i].z,2))+R122*(z2-obs_p_[i].z));
				w212=((x2-obs_p_[i].x)*(y1-obs_p_[i].y))/((pow(x2-obs_p_[i].x,2)+pow(z2-obs_p_[i].z,2))+R212*(z2-obs_p_[i].z));
				w112=((x1-obs_p_[i].x)*(y1-obs_p_[i].y))/((pow(x1-obs_p_[i].x,2)+pow(z2-obs_p_[i].z,2))+R112*(z2-obs_p_[i].z));
				w221=((x2-obs_p_[i].x)*(y2-obs_p_[i].y))/((pow(x2-obs_p_[i].x,2)+pow(z1-obs_p_[i].z,2))+R221*(z1-obs_p_[i].z));
				w121=((x1-obs_p_[i].x)*(y2-obs_p_[i].y))/((pow(x1-obs_p_[i].x,2)+pow(z1-obs_p_[i].z,2))+R121*(z1-obs_p_[i].z));
				w211=((x2-obs_p_[i].x)*(y1-obs_p_[i].y))/((pow(x2-obs_p_[i].x,2)+pow(z1-obs_p_[i].z,2))+R211*(z1-obs_p_[i].z));
				w111=((x1-obs_p_[i].x)*(y1-obs_p_[i].y))/((pow(x1-obs_p_[i].x,2)+pow(z1-obs_p_[i].z,2))+R111*(z1-obs_p_[i].z));
				
				G222=-Alpha*arctg(w222)+Beta*log(R222+z2-2)+Gamma*log(R222+y2-obs_p_[i].y);
				G122=-Alpha*arctg(w122)+Beta*log(R122+z2-2)+Gamma*log(R122+y2-obs_p_[i].y);
				G212=-Alpha*arctg(w212)+Beta*log(R212+z2-2)+Gamma*log(R212+y1-obs_p_[i].y);
				G112=-Alpha*arctg(w112)+Beta*log(R112+z2-2)+Gamma*log(R112+y1-obs_p_[i].y);
				G221=-Alpha*arctg(w221)+Beta*log(R221+z1-2)+Gamma*log(R221+y2-obs_p_[i].y);
				G121=-Alpha*arctg(w121)+Beta*log(R121+z1-2)+Gamma*log(R121+y2-obs_p_[i].y);
				G211=-Alpha*arctg(w211)+Beta*log(R211+z1-2)+Gamma*log(R211+y1-obs_p_[i].y);
				G111=-Alpha*arctg(w111)+Beta*log(R111+z1-2)+Gamma*log(R111+y1-obs_p_[i].y);
