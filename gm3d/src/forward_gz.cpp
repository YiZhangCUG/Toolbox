...
int GM3D::ForwardGz(char* noise_level){
	int i,j;
...
#pragma omp parallel for private(j,R222,R122,R212,R112,R221,R121,R211,R111,G222,G122,G212,G112,G221,G121,G211,G111,x1,x2,y1,y2,z1,z2) shared(i) schedule(guided)
		for (j = 0; j < model_num_; j++){
			if (fabs(forward_model_[j]) > ZERO){
				...
				G222=atan((x2-grav_obs_[i].x)*(y2-grav_obs_[i].y)/(R222*(z2-grav_obs_[i].z)));
				G122=atan((x1-grav_obs_[i].x)*(y2-grav_obs_[i].y)/(R122*(z2-grav_obs_[i].z)));
				G212=atan((x2-grav_obs_[i].x)*(y1-grav_obs_[i].y)/(R212*(z2-grav_obs_[i].z)));
				G112=atan((x1-grav_obs_[i].x)*(y1-grav_obs_[i].y)/(R112*(z2-grav_obs_[i].z)));
				G221=atan((x2-grav_obs_[i].x)*(y2-grav_obs_[i].y)/(R221*(z1-grav_obs_[i].z)));
				G121=atan((x1-grav_obs_[i].x)*(y2-grav_obs_[i].y)/(R121*(z1-grav_obs_[i].z)));
				G211=atan((x2-grav_obs_[i].x)*(y1-grav_obs_[i].y)/(R211*(z1-grav_obs_[i].z)));
				G111=atan((x1-grav_obs_[i].x)*(y1-grav_obs_[i].y)/(R111*(z1-grav_obs_[i].z)));
